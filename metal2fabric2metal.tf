...
## Create VC via dedciated port in metro "da"
...
resource "equinix_metal_connection" "example" {
  ...
  contact_email      = "mzeigler@equinix.com"
...
resource "equinix_fabric_connection" "this" {
  name = "MZLab-metalport-fabric"
  type = "EVPL_VC"
  bandwidth = 50
  notifications {
    type   = "ALL"
    emails = ["mzeigler@equinix.com"]
  }
  order {
